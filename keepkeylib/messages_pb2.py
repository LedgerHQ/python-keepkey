...
U2FInit = _reflection.GeneratedProtocolMessageType('U2FInit', (_message.Message,), dict(
  DESCRIPTOR = _U2FINIT,
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:U2FInit)
  ))
_sym_db.RegisterMessage(U2FInit)

U2FGetCounter = _reflection.GeneratedProtocolMessageType('U2FGetCounter', (_message.Message,), dict(
  DESCRIPTOR = _U2FGETCOUNTER,
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:U2FGetCounter)
  ))
_sym_db.RegisterMessage(U2FGetCounter)

U2FCounter = _reflection.GeneratedProtocolMessageType('U2FCounter', (_message.Message,), dict(
  DESCRIPTOR = _U2FCOUNTER,
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:U2FCounter)
  ))
_sym_db.RegisterMessage(U2FCounter)

U2FSetEntry = _reflection.GeneratedProtocolMessageType('U2FSetEntry', (_message.Message,), dict(
  DESCRIPTOR = _U2FSETENTRY,
  __module__ = 'messages_pb2'
  # @@protoc_insertion_point(class_scope:U2FSetEntry)
  ))
_sym_db.RegisterMessage(U2FSetEntry)
...
_MESSAGETYPE.values_by_name["MessageType_U2FInit"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001'))
_MESSAGETYPE.values_by_name["MessageType_U2FGetCounter"].has_options = True
_MESSAGETYPE.values_by_name["MessageType_U2FGetCounter"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001'))
_MESSAGETYPE.values_by_name["MessageType_U2FCounter"].has_options = True
_MESSAGETYPE.values_by_name["MessageType_U2FCounter"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\230\265\030\001'))
_MESSAGETYPE.values_by_name["MessageType_U2FSetEntry"].has_options = True
_MESSAGETYPE.values_by_name["MessageType_U2FSetEntry"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\220\265\030\001'))
